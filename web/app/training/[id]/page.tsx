                        ...
                        <div className="space-y-6 pt-8 border-t border-white/5">
                            <div className="flex items-center justify-between pb-2">
                                ...
                                <span className="text-xs font-mono text-muted-foreground bg-secondary/50 px-2 py-1 rounded">
                                    {modules.reduce((acc, m) => acc + m.items.length, 0)} Tactical Units
                                </span>
                            </div>
                                            ...
                                            <div className="divide-y divide-white/5">
                                                {module.items.map((item) => {
                                                    ...
                                                    return (
                                                        <div
                                                            key={item.id}
                                                            onClick={() => isUnlocked && router.push(`/training/${id}/lesson/${item.id}`)}
                                                            className={`p-4 flex items-center gap-4 transition-colors group ${isUnlocked ? 'hover:bg-white/5 cursor-pointer' : 'opacity-60 cursor-not-allowed'
                                                                }`}
                                                        >
                        ...
                        <div className="sticky top-8 space-y-6">
                            ...
                            >
                                ...
                                <AnimatePresence mode="wait">
                                    {enrollmentStatus === 'already_enrolled' || enrollmentStatus === 'success' ? (
                                        <motion.div
                                            key="active"
                                        ...
                                        >
                                            {enrolling ? (
                                                ...
                                                <>
                                                    {course.enrollment_mode === 'manual' ? "REQUEST MISSION CLEARANCE" : "INITIALIZE DEPLOYMENT"}
