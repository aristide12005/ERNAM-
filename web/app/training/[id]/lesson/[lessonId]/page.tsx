...
export default function LessonPlayerPage() {
    ...
    if (loading) return <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center text-white">Loading mission data...</div>;
    if (!lesson) return <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center text-white">Lesson not found.</div>;
                    ...
                    <div className="flex-1 p-8 bg-black/20 overflow-y-auto">
                        ...
                        <div className="prose prose-invert max-w-none">
                            <p className="text-gray-400">
                                {lesson.description || "Review the materials above carefully. Your progress is being tracked automatically."}
                            </p>
                        </div>
                    </div>
                </main>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                {completing ? (
                                    ...
                                    <>
                                        Mark Complete <ChevronRight className="h-4 w-4" />
                                    </>
                                ) : (
                                    <>
                            ...
                            {progress === 'completed' && (
                                <p className="text-xs text-center text-emerald-500/70 font-medium">
                                    Progress recorded at {new Date().toLocaleTimeString()}
                                </p>
                            )}
                        </div>
                    </div>
