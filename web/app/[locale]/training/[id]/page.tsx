                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                <span className={`px - 3 py - 1 rounded - full text - xs font - bold tracking - wider uppercase border flex items - center gap - 2 ${course.enrollment_mode === 'manual'
                                    ...
                                    {course.enrollment_mode === 'manual' ? (
                                        <><Lock className="h-3 w-3" /> {t('restricted_access')}</>
                                    ) : (
                                        <><Plane className="h-3 w-3" /> {t('open_enrollment')}</>
                                    )}
                                </span>
                        ...
                        <div className="space-y-6 pt-8 border-t border-white/5">
                            <div className="flex items-center justify-between pb-2">
                                ...
                                <span className="text-xs font-mono text-muted-foreground bg-secondary/50 px-2 py-1 rounded">
                                    {modules.reduce((acc, m) => acc + m.items.length, 0)} {t('units')}
                                </span>
                            </div>
                                ...
                                <AnimatePresence mode="wait">
                                    {enrollmentStatus === 'success' || enrollmentStatus === 'already_enrolled' ? (
                                        ...
                                        >
                                            ...
                                            <div>
                                                <h3 className="text-emerald-400 font-bold text-lg">{t('mission_active')}</h3>
                                                <p className="text-xs text-emerald-500/70">{t('secure_channel')}</p>
                                            </div>
                                        ...
                                        >
                                            ...
                                            <div>
                                                <h3 className="text-amber-400 font-bold text-lg">{t('clearance_pending')}</h3>
                                                <p className="text-xs text-amber-500/70">
                                                    {t('review_in_progress')}
                                                </p>
                                            </div>
                                        </motion.div>
                                    ) : (
                                        ...
                                        >
                                            {enrolling ? (
                                                ...
                                                <>
                                                    {course.enrollment_mode === 'manual' ? t('request_clearance') : t('confirm_enrollment')}
